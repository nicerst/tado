...
export const SKILL_NAMES = [
  ...
  "dev-workflow/ai-automation-delivery-loop",
  ...
  "dev-workflow/decision-review",
  "dev-workflow/fable-mode",
  "dev-workflow/git-worktree-isolation",
...
export const SKILL_GROUPS = {
  ...
  "dev-workflow": [
    "agent-observability", "agentic-review-loop", "agentic-system-design", "ai-automation-delivery-loop", "claude-code-idea-to-build-loop",
    "claude-code-website-hacks", "claude-desktop-agent-workflow", "claude-design-workflow", "cloud-agent-build-verify-loop", "decision-review", "fable-mode",
    "git-worktree-isolation", "goal-file-orchestration-prompt", "herder-agent-workspace", "in-house-ai-consultant-roadmap",
