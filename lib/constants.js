...
export const SKILL_GROUPS = {
  ...
  "dev-workflow": [
    ...
    "claude-code-website-hacks", "claude-design-workflow", "fable-mode",
    "goal-file-orchestration-prompt", "in-house-ai-consultant-roadmap",
    "phased-app-build-system", "repo-to-skill", "yt-to-skill"
  ],
  writing:     ["humanize-proofreader"],
